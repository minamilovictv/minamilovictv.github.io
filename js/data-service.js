  ...
  const SAMPLE_NEWS = [
    {
      ...
      date: '2026-06-14',
      excerpt: 'The Western Balkans Fund announces the opening of the ninth call under the Grants for Grassroots Initiatives (GGI) scheme, supporting civil society, cultural and educational projects across WB6.',
      content: '<p>The Western Balkans Fund is pleased to announce the opening of <strong>GGI Call No. 9</strong> — the ninth call under the Grants for Grassroots Initiatives (GGI) grants scheme.</p><h3>Who can apply</h3><ul><li>Registered civil society organizations</li><li>Cultural institutions and museums</li><li>Universities and research institutes</li><li>Local government bodies (in partnership)</li></ul><h3>Key dates</h3><p>The call opens on <strong>14 June 2026</strong> and closes on <strong>15 September 2026</strong> at 17:00 CET.</p><p>For full eligibility criteria, partnership requirements and application guidelines, please consult the <a href="grants-how-to-apply.html">How to Apply</a> page or download the call documentation below.</p>',
    ...
    },
    {
      ...
      title: 'WB6-V4 Fellowship — 3rd Edition opens to WB6 researchers',
      slug: 'visegrad-fellowship-3rd',
      type: 'announcement',
      programme: 'WB6-V4 Fellowship',
      date: '2026-06-10',
      ...
      content: '<p>In partnership with the International Visegrad Fund, WBF is launching the third edition of the WB6-V4 Fellowship — supporting doctoral students and recent graduates from the Western Balkans connecting with V4 countries.</p><p>Fellows will spend up to 12 months at a host institution in the Czech Republic, Hungary, Poland, or Slovakia.</p>',
